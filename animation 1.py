...
def move():
    ...
    if flag >0: 
        #la fonction after permet d'appeler une fonction apres un certain temps
...
#remarque il est possible d'empecher le redimetionement d'une fen Tkinter grace a :
